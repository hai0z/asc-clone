...
export default function Debt({ navigation }) {
  ...
  return (
    <View>
      <HeaderBar title='Công nợ' iconName='solution1' navigation={navigation} />
      <LinearGradient
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 0 }}
          ...
          return (
            <View key={item.id} style={{ marginHorizontal: 10 }}>
              ...
              <View
                ...
                <Text style={{ color: "coral" }}>{item.hp}</Text>
                <Text style={{ color: "blue" }}>{item.dn}</Text>
                <Text style={{ color: "#d5d5d5" }}>{item.kt}</Text>
                <Text style={{ color: "#d5d5d5" }}>{item.cn}</Text>
              </View>
            </View>
          );
        })}
      ...
      <View
        ...
        <Text style={{ fontSize: 20, fontWeight: "500" }}>Tổng công nợ</Text>
