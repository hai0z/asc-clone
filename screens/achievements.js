            ...
            <View key={item.id}>
              <View style={{ flexDirection: "row", marginTop: 30 }}>
                <View
                  ...
                  <Text style={{ width: 70, fontSize: 12 }}>{item.name}</Text>
                </View>
                <View style={{ width: "100%" }}>
                  <View style={{ flexDirection: "row", alignItems: "center" }}>
                    <View
                      style={{
                        width: item.myPoint * 10 - 20 + "%",
                        height: 35,
                        backgroundColor: "coral",
                      }}
                    />
                    ...
                    <View
                      ...
                      <Text style={{ color: "#fff" }}>{item.myPoint}</Text>
                    </View>
                  </View>
                  <View style={{ flexDirection: "row", alignItems: "center" }}>
                    <View
                      style={{
                        width: item.classPoint * 10 - 20 + "%",
                        height: 35,
                        backgroundColor: "gold",
                      }}
                    />
                    <View
                      ...
                      <Text style={{ color: "#000" }}>{item.classPoint}</Text>
                    </View>
                  </View>
                </View>
              </View>
